...
{
	UE_LOG(LogDedicatedServers, Log, TEXT("FDSPlayerSession Contents:"));
	UE_LOG(LogDedicatedServers, Log, TEXT("  CreationTime: %s"), *CreationTime);
	UE_LOG(LogDedicatedServers, Log, TEXT("  DnsName: %s"), *DnsName);
	UE_LOG(LogDedicatedServers, Log, TEXT("  FleetArn: %s"), *FleetArn);
	UE_LOG(LogDedicatedServers, Log, TEXT("  FleetId: %s"), *FleetId);
...
{
	UE_LOG(LogDedicatedServers, Log, TEXT("FNewDeviceMetadata:"));
...
{
	UE_LOG(LogDedicatedServers, Log, TEXT("FAuthenticationResult:"));
...
{
	UE_LOG(LogDedicatedServers, Log, TEXT("FChallengeParameters:"));
...
{
	UE_LOG(LogDedicatedServers, Log, TEXT("FDSSignInResponse:"));
...
void FDSRetrieveMatchStatsResponse::Dump() const
{
	...
	UE_LOG(LogDedicatedServers, Log, TEXT("showStoperElims: %d"), showStopperElims);
